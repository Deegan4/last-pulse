...
node .Codex/skills/run-brawl-arena/driver.mjs --play --mode br --shoot
```

The driver (see `.Codex/skills/run-brawl-arena/`) launches the bundled Chromium
...
Work on the designated `Codex/...` branch and open a draft PR. **`git push origin main`
