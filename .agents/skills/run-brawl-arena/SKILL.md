...
[`.Codex/skills/run-brawl-arena/driver.mjs`](driver.mjs), that launches the **bundled
...
```bash
node .Codex/skills/run-brawl-arena/driver.mjs
```
...
```bash
node .Codex/skills/run-brawl-arena/driver.mjs --play --mode horde
node .Codex/skills/run-brawl-arena/driver.mjs --play --mode br
```
...
```bash
node .Codex/skills/run-brawl-arena/driver.mjs --play --mode horde --shoot --seconds 4
```
